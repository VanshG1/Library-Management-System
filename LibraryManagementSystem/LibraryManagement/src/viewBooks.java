...
public class viewBooks extends JFrame implements ActionListener{
    ...
    public void actionPerformed(ActionEvent ae)
    {
        ...
        try{
            ...
            if(ae.getSource() == db){
                String sql = "insert into bookBackup select *from book where book_id = ? and name = ?";
                PreparedStatement st = con.prepareStatement(sql);
                st.setString(1, txt2.getText());
                ...
                int i = st.executeUpdate();
                if (i>0) {
                    JOptionPane.showConfirmDialog(null, "Do you want to Remove book?");
                    delete();
                }
