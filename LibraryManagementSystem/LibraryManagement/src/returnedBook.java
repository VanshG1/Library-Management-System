...
public class returnedBook extends JFrame implements ActionListener{
    ...
    public void returnBook() {
        ...
        try{
            ...
            while(rs.next()){
                ...
                String doF = rs.getString("dateOfReturn");

                String tbData[] = {sid, bid , Bname, Sname,Course,Branch,doI,doF};
                String tbData11[] = {"Student ID", "Book ID" , "Book Name", "Student Name", "Course", "Branch","Date of Issue", "Date of Return"};
    ...
    public returnedBook(){
        ...
        Color textColor = new Color(9, 159, 255); 
        ...
        b.setBackground(textColor);
        b.setForeground(Color.WHITE);
        contentPane.add(b);

        l = new JLabel("Returned Book Details");
